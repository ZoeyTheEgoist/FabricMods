...
/*
    ...
    public static void registerItems() {
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_white_wool"), LUMINOUS_WHITE_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_orange_wool"), LUMINOUS_ORANGE_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_magenta_wool"), LUMINOUS_MAGENTA_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_light_blue_wool"), LUMINOUS_LIGHT_BLUE_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_yellow_wool"), LUMINOUS_YELLOW_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_lime_wool"), LUMINOUS_LIME_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_pink_wool"), LUMINOUS_PINK_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_gray_wool"), LUMINOUS_GRAY_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_light_gray_wool"), LUMINOUS_LIGHT_GRAY_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_cyan_wool"), LUMINOUS_CYAN_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_purple_wool"), LUMINOUS_PURPLE_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_blue_wool"), LUMINOUS_BLUE_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_brown_wool"), LUMINOUS_BROWN_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_green_wool"), LUMINOUS_GREEN_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_red_wool"), LUMINOUS_RED_WOOL);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_black_wool"), LUMINOUS_BLACK_WOOL);

        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_white_carpet"), LUMINOUS_WHITE_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_orange_carpet"), LUMINOUS_ORANGE_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_magenta_carpet"), LUMINOUS_MAGENTA_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_light_blue_carpet"), LUMINOUS_LIGHT_BLUE_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_yellow_carpet"), LUMINOUS_YELLOW_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_lime_carpet"), LUMINOUS_LIME_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_pink_carpet"), LUMINOUS_PINK_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_gray_carpet"), LUMINOUS_GRAY_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_light_gray_carpet"), LUMINOUS_LIGHT_GRAY_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_cyan_carpet"), LUMINOUS_CYAN_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_purple_carpet"), LUMINOUS_PURPLE_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_blue_carpet"), LUMINOUS_BLUE_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_brown_carpet"), LUMINOUS_BROWN_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_green_carpet"), LUMINOUS_GREEN_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_red_carpet"), LUMINOUS_RED_CARPET);
        Registry.register(Registries.ITEM, Identifier.of(LuminousWool.MOD_ID, "luminous_black_carpet"), LUMINOUS_BLACK_CARPET);
